...
export default function OrderConfirmation() {
  return (
    <>
      <SEO title="Order Confirmation" description="Your bakery order has been confirmed at Craving Station." />
      <section className="min-h-[70vh] flex items-center justify-center px-4 py-24 sm:px-6 lg:px-8">
        <div className="w-full max-w-xl rounded-3xl border border-white/10 bg-white/5 p-10 text-center backdrop-blur-sm">
          ...
          <p className="mb-6 text-lg text-yakoyo-muted">Thank you for your order. We’re preparing your bakery items and will notify you once they’re ready for delivery or pickup.</p>
          <Link
            to="/"
